...
activities = {
    ...
    "Swimming Club": {
        "description": "Build endurance and technique with lap swimming and drills",
    ...
    "Debate Team": {
        "description": "Research topics and develop public speaking and argument skills",
    ...
    "Science Club": {
        ...
        "max_participants": 18,
        "participants": ["avery@mergington.edu", "lucas@mergington.edu"]
    }
}
